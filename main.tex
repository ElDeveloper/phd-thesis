...
\chapter{The hidden world within ourselves}

\include{chapter_review}

%\chapter{Visualizing complex microbial communities}
\chapter{Exploratory microbiome data visualization}
...
\chapter{Dynamic features of inflammatory bowel disease}

\include{chapter_plane}
\include{chapter_ibd}

\chapter{Restoring a lost ecosystem with fecal microbiome transplants}
