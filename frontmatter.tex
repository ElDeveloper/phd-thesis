...
\begin{abstract}
    ...
    computing, and efficient representations of large datasets are catalyzers
    of insight into omnipresent and complex microbial interactions. Notably,
    classical ecologists have set the foundations for the way we analyze these
    systems, with some techniques dating back to the beginning of the twentieth
    century.  In this thesis, we expand and where possible reuse these
    techniques to enhance our understanding of microbial systems.
